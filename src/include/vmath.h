...
class vec2
{
  public:
    ...
    static vec2<T> rand()
    {
      vec2<T> ret;
      do {
        ret = vec2<T>((T)2 * (T)::rand() / (T)RAND_MAX - (T)1,
...
class vec3
{
  public:
    ...
    static vec3<T> rand()
    {
      vec3<T> ret;
      do {
        ret = vec3<T>((T)2 * (T)::rand() / (T)RAND_MAX - (T)1,
                      (T)2 * (T)::rand() / (T)RAND_MAX - (T)1,
                      (T)2 * (T)::rand() / (T)RAND_MAX - (T)1);
      } while (ret.lengthsq() > (T)1);
      return ret;
...
class mat44
{
  public:
    ...
    {
      mat44<T> ret;
      ret.row[0][0] = row[0][0] * mat.row[0][0] + row[0][1] * mat.row[1][0] + row[0][2] * mat.row[2][0] + row[0][3] *
                      mat.row[3][0];
      ret.row[0][1] = row[0][0] * mat.row[0][1] + row[0][1] * mat.row[1][1] + row[0][2] * mat.row[2][1] + row[0][3] *
                      mat.row[3][1];
      ret.row[0][2] = row[0][0] * mat.row[0][2] + row[0][1] * mat.row[1][2] + row[0][2] * mat.row[2][2] + row[0][3] *
                      mat.row[3][2];
      ret.row[0][3] = row[0][0] * mat.row[0][3] + row[0][1] * mat.row[1][3] + row[0][2] * mat.row[2][3] + row[0][3] *
                      mat.row[3][3];
      ret.row[1][0] = row[1][0] * mat.row[0][0] + row[1][1] * mat.row[1][0] + row[1][2] * mat.row[2][0] + row[1][3] *
                      mat.row[3][0];
      ret.row[1][1] = row[1][0] * mat.row[0][1] + row[1][1] * mat.row[1][1] + row[1][2] * mat.row[2][1] + row[1][3] *
                      mat.row[3][1];
      ret.row[1][2] = row[1][0] * mat.row[0][2] + row[1][1] * mat.row[1][2] + row[1][2] * mat.row[2][2] + row[1][3] *
                      mat.row[3][2];
      ret.row[1][3] = row[1][0] * mat.row[0][3] + row[1][1] * mat.row[1][3] + row[1][2] * mat.row[2][3] + row[1][3] *
                      mat.row[3][3];
      ret.row[2][0] = row[2][0] * mat.row[0][0] + row[2][1] * mat.row[1][0] + row[2][2] * mat.row[2][0] + row[2][3] *
                      mat.row[3][0];
      ret.row[2][1] = row[2][0] * mat.row[0][1] + row[2][1] * mat.row[1][1] + row[2][2] * mat.row[2][1] + row[2][3] *
                      mat.row[3][1];
      ret.row[2][2] = row[2][0] * mat.row[0][2] + row[2][1] * mat.row[1][2] + row[2][2] * mat.row[2][2] + row[2][3] *
                      mat.row[3][2];
      ret.row[2][3] = row[2][0] * mat.row[0][3] + row[2][1] * mat.row[1][3] + row[2][2] * mat.row[2][3] + row[2][3] *
                      mat.row[3][3];
      ret.row[3][0] = row[3][0] * mat.row[0][0] + row[3][1] * mat.row[1][0] + row[3][2] * mat.row[2][0] + row[3][3] *
                      mat.row[3][0];
      ret.row[3][1] = row[3][0] * mat.row[0][1] + row[3][1] * mat.row[1][1] + row[3][2] * mat.row[2][1] + row[3][3] *
                      mat.row[3][1];
      ret.row[3][2] = row[3][0] * mat.row[0][2] + row[3][1] * mat.row[1][2] + row[3][2] * mat.row[2][2] + row[3][3] *
                      mat.row[3][2];
      ret.row[3][3] = row[3][0] * mat.row[0][3] + row[3][1] * mat.row[1][3] + row[3][2] * mat.row[2][3] + row[3][3] *
                      mat.row[3][3];
      return ret;
    }
...
class quat
{
  ...
  public:
    ...
    static quat<T> rand()
    {
      ...
      float lengthsq;
      do {
        ret = quat<T>((T)2 * (T)::rand() / (T)RAND_MAX - (T)1,
                      (T)2 * (T)::rand() / (T)RAND_MAX - (T)1,
                      (T)2 * (T)::rand() / (T)RAND_MAX - (T)1,
                      (T)2 * (T)::rand() / (T)RAND_MAX - (T)1);
